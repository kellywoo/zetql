...
`;
const OrderSummaryContent = ({ summary }: { summary: OrderSummaryModel }) => {
    ...
    <>
      <Header>
        ...
        <PriceSummaryRow>
          ...
          <dd>
            <LocaleNumber
              amount={Math.max(totalProductPrice - couponDiscount, 0)}
            />
          </dd>
        </PriceSummaryRow>
      </Header>
...
export const OrderSummaryModal = () => {
  ...
  return (
    <ContentModal
      ...
      showCloseButton
    >
      {orderSummary ? <OrderSummaryContent summary={orderSummary} /> : null}
    </ContentModal>
  );
};
