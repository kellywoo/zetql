...
import { ProductMain } from '@/pages/order/mains/ProductMain.tsx';
import { categoryQuery } from '@/subjects/category/category.query';
import { productQuery } from '@/subjects/product/product.query';
import { ProductDetailModal } from '@/pages/order/modals/ProductDetailModal';
import { OrderSummaryModal } from '@/pages/order/modals/OrderSummaryModal';
import { SelectCouponModal } from '@/pages/order/modals/SelectCouponModal';
import { OrderCartMain } from '@/pages/order/mains/OrderCartMain.tsx';
import { useQueryFetch, useSubjectValue } from '@zetql/react';
import { AppGutter, AppLayout } from "@/components/layout/AppLayout.tsx";
...
export const OrderPage = () => {
	...
	return (
		<AppLayout
			header={
				<AppMenuNav menu={categories} activeMenu={activeCategory.selected} setActive={activeCategory.setSelected} />
			}
		>
			<Wrapper>
				<ProductSection>
