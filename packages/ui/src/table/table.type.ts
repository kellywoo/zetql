import { TableSortLabel, UiTableSetState, UiTableState } from "@ui/table/useTableState.tsx";
...
export type TableSearchQuery<T> = (item: T, q: string, tableState: UiTableState) => boolean;
...
export type TableGeneratorRow<T> = {
  ...
  headSelect?: { options: Array<SelectOption<string>>; filter: TableSearchQuery<T> };
};
